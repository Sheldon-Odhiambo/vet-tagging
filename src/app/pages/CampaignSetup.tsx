...
import { ChevronLeft, ChevronRight, Target, Users, Upload, MapPin, Trash2, Save, Calendar, Briefcase, Plus } from 'lucide-react';
    ...
    <div className="p-8 bg-gray-50 min-h-screen text-gray-900 flex justify-center">
      <div className="w-full lg:w-[1200px] lg:h-[1200px] bg-white p-8 rounded-xl border border-gray-200 shadow-sm overflow-y-auto">
        <div className="mb-12">
          ...
          <p className="text-gray-600">Step {step} of 5{step !== 1 && step !== 2 && step !== 3 && step !== 4 ? `: ${step === 5 ? 'Operations' : ''}` : ''}</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                ...
                <button onClick={addStaff} className="bg-blue-900 text-white p-2 rounded-lg font-bold hover:bg-blue-950 transition-colors"><Plus className="w-5 h-5" /></button>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                ...
                <button onClick={addSecurity} className="bg-blue-900 text-white p-2 rounded-lg font-bold hover:bg-blue-950 transition-colors"><Plus className="w-5 h-5" /></button>
              </div>
        ...
        {step === 3 && (
          <div className="space-y-4">
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button onClick={addVolunteer} className="bg-blue-900 text-white p-2 rounded-lg font-bold hover:bg-blue-950 transition-colors"><Plus className="w-5 h-5" /></button>
            </div>
